...
const { data: carsData, refresh: refreshCars } = await useFetch<CarsResponse>(
  "/api/cars",
  {
    method: "GET",
    query: computed(() => ({
...
<template>
  <UContainer class="py-8">
    ...
    <div class="mb-6">
      <UFormGroup
        label="Search Cars"
        description="Search by customer name, year, make, model, VIN, license plate, or fleet">
        <UInput
          v-model="searchQuery"
      ...
      <UCard
        ...
        <div class="space-y-4">
          ...
          <div class="flex items-center gap-4">
            <UAvatar size="lg" class="bg-blue-500 dark:bg-blue-400">
    ...
    <UModal v-model="isAddCarOpen">
      <UCard>
        ...
        <div class="space-y-4">
          ...
          <UButton block variant="outline" @click="isAddCarOpen = false">
            Close
          </UButton>
        </div>
      </UCard>
